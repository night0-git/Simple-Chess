...
std::vector<sf::Vector2i> Bishop::getValidMoves(sf::Vector2i currentSquare, const Board& board) const {
    return getDiagonalMoves(currentSquare, board, this->getColor());
}

std::vector<sf::Vector2i> getDiagonalMoves(sf::Vector2i currentSquare, const Board& board, PieceColor color) {
